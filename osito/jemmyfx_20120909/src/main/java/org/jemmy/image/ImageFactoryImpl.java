...
public class ImageFactoryImpl implements ImageFactory {
    ...
    public ImageFactoryImpl(ImageCapturer imageCapturer, ImageLoader imageLoader) {
    ...
    public Image capture(Wrap<?> control, Rectangle rect) {
        return imageCapturer.capture(control, rect);
    }
