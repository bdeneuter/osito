...
public class ByToStringLookup<CONTROL> extends ByStringLookup<CONTROL> {
    ...
    public ByToStringLookup(String text) {
        super(text);
    }
    ...
    public ByToStringLookup(String text, int index) {
        super(text, index);
    }

    public ByToStringLookup(String text, StringComparePolicy policy, int index) {
        super(text, policy, index);
    }
