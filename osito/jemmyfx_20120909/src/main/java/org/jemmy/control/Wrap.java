...
public abstract class Wrap<CONTROL extends Object> implements MouseTarget, KeyTarget {
    ...
    /**
     * @deprecated {@linkplain ImageFactory ImageFactory} interface is
     * deprecated, use {@linkplain ImageCapturer ImageCapturer} and
    ...
    /**
     *
     * @deprecated Use getEnvironment().getInputFactory()
     */
    private static ControlInterfaceFactory getInputFactory() {
        return Environment.getEnvironment().getInputFactory();
    }

    /**
     *
     * @param inputFactory
     * @deprecated Use getEnvironment().setInputFactory(factory)
     */
    public static void setInputFactory(ControlInterfaceFactory inputFactory) {
        Environment.getEnvironment().setInputFactory(inputFactory);
    }

    /**
     *
     * @deprecated Use getEnvironment().getImageFactory()
     * @return
     */
    public static ImageFactory getImageFactory() {
        return Environment.getEnvironment().getImageFactory();
    }

    /**
     *
     * @param factory
     * @deprecated Use getEnvironment().setImageFactory(factory)
     */
    public static void setImageFactory(ImageFactory factory) {
        Environment.getEnvironment().setImageFactory(factory);
    }
    ...
    private Method findAsMethod(Class<? extends ControlInterface> interfaceClass, Class type) {
        while (type != null) {
            for (Method m : getClass().getMethods()) {
                ...
                if (as != null && interfaceClass.isAssignableFrom(returnType)) {
